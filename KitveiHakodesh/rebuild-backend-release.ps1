...
$backendRoot = Join-Path $repoRoot 'KitveiHakodesh\CSharpBackend'
$solutionPath = Join-Path $backendRoot 'KitveiHakodesh.slnx'
$libPath = Join-Path $backendRoot 'KitveiHakodeshLib\KitveiHakodeshLib.csproj'
$searchPath = Join-Path $backendRoot 'BloomSearchEngine\BloomSearchEngineLib\BloomSearchEngineLib.csproj'
$demoPath = Join-Path $backendRoot 'KitveiHakodeshDemoApp\KitveiHakodeshDemoApp.csproj'
...
Write-Info "Building KitveiHakodesh backend in Release..."
