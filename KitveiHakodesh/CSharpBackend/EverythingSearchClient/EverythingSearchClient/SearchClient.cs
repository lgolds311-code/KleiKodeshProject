...
namespace EverythingSearchClient
{
	...
	public class SearchClient
	{
		...
		/// <summary>
		/// Checks if the Everything service is available AND its database has finished loading.
		/// Returns false while Everything is still building its index after startup.
		/// This is the correct readiness check before issuing search queries.
		/// </summary>
		...
		public enum BehaviorWhenBusy
		{
			...
			/// <summary>
			/// Continue issuing the query regardless of busy state.
			/// </summary>
			Continue
		}
		...
		{
			/// <summary>
			/// Tries to call the best API first, and may fallback to the other on loss of functionality
			/// </summary>
			Any,
			...
			/// <summary>
			/// Query 2 API of Everything IPC — does not fall back to Query1
			/// </summary>
			Query2only
		}
			...
			SortDirection sortDirection = SortDirection.Ascending)
		{
			...
			MessageReceiverWindow myWnd = new MessageReceiverWindow();
