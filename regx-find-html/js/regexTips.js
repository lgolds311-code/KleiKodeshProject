...
export const regexTips = [
  ...
  {
    "Symbol": "$0",
    "Meaning": "כל הטקסט שנמצא",
    "Example": "$0 → כל הטקסט שהתאים לחיפוש"
  },
  {
    "Symbol": "$1, $2, $3",
    "Meaning": "קבוצות לכידה מרובות",
    "Example": "(\\w+) (\\w+) → $2 $1 (החלפת סדר מילים)"
  },
  {
    "Symbol": "(.+) → $1$1",
    "Meaning": "כפילת הטקסט שנמצא",
    "Example": "שלום → שלוםשלום"
  },
  {
    "Symbol": "(\\d+) → מספר: $1",
    "Meaning": "הוספת טקסט לפני/אחרי הקבוצה",
    "Example": "123 → מספר: 123"
  },
  {
    "Symbol": "\\b.*?",
    "Meaning": "תחיליות",
