...
namespace KezayitLib.Dictionary
{
    ...
    public class DictionaryHandler
    {
        ...
        private readonly DbAccess _wikiDictDb;
        ...
        public bool IsWikiDbReady    => _wikiDictDb    != null;
        ...
        /// <summary>Runs a SQL query against the Hebrew Wiktionary database.</summary>
        public IEnumerable<IDictionary<string, object>> QueryWiki(string sql, object[] parameters)
            => _wikiDictDb.Query(sql, parameters);
    }
}
