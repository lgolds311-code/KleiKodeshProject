...
| Project                | Role                                                                      |
| ---------------------- | ------------------------------------------------------------------------- |
| `KezayitLib`           | WebView2 host, message bridge, SQLite access, PDF handling, file I/O      |
| `BloomSearchEngineLib` | Bloom filter index builder and searcher for full-text search              |
| `KezayitDemoApp`       | Standalone WinForms harness for running the Vue app outside of production |
