...
**FileSystemPage.vue** - main page, orchestrates the title bar, search bar, and view switching between list, tiles, and tree via a `<component :is>` map.

**FileSystemTitleBar.vue** - breadcrumb and view-mode toggle (list / tiles / full tree).

**FileSystemTreeView.vue** - collapsible category tree showing the full catalog hierarchy.

**FileSystemTileView.vue** - tiles view at the current breadcrumb level.

**FileSystemListView.vue** - list view at the current breadcrumb level.

**FileSystemSearch.vue** - renders book matches and TOC entry matches.

**FileSystemBreadcrumb.vue** - breadcrumb trail for the current folder path.
