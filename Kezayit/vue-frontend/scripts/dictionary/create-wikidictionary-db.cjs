...
db.exec(`
  ...
  -- lang: content language — always 'עברית' for this DB.
  CREATE TABLE source (
    id    INTEGER PRIMARY KEY,
    label TEXT NOT NULL UNIQUE,
    lang  TEXT,                  -- 'עברית' for ויקימילון
    url   TEXT                   -- source URL
  );
  ...
  CREATE TABLE sense (
    ...
    ktiv_male   TEXT,
    etymology   TEXT,
    cross_ref   TEXT,             -- NULL for wiki entries (Aramaic-only field, kept for schema sync)
