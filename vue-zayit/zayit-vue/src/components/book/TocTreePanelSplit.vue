    ...
    <Transition name="slide">
        <div class="flex-column height-fill book-toc-tree-view"
            ...
            <div class="flex-110 flex-column toc-content">
                ...
                <template v-else>
                    <!-- Regular TOC -->
                    <div v-if="regularTocEntries.length > 0" class="toc-section overflow-y">
                    ...
                    <!-- Alt TOC (חלוקה אחרת) -->
                    <div v-if="altTocEntries.length > 0 && props.showAltToc !== false" class="toc-section overflow-y alt-toc-section">
