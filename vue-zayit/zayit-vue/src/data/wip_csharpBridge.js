// WIP C# WebView2 Bridge (work-in-progress)
// This file is intentionally kept as a WIP and should not be imported by the app.
// Renamed from `csharpBridge.js` to avoid shadowing the TypeScript module.
