...
export const createVirtualStore = (
  ...
  return {
    ...
    $getScrollOffset: () => getRelativeScrollOffset(),
    $getScrollPosition: () => {
      const offset = getRelativeScrollOffset();
      const index = findIndex(cache, offset);
      const itemOffset = getItemOffset(index);
      const pixelOffset = offset - itemOffset;
      return { index, offset: pixelOffset };
    },
