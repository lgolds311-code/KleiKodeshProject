...
@Composable
fun ConditionsSettingsScreen() {
    ConditionsSettingsView()
}

@Composable
private fun ConditionsSettingsView() {
...
@Composable
@Preview
private fun ConditionsSettingsViewPreview() {
    PreviewContainer { ConditionsSettingsView() }
}
