...
namespace Kezayit.HebrewBooks
{
    /// <summary>
    /// Incrementally updates kezayit\HebrewBooks.csv once a month.
    ...
    public class HebrewBooksCsvUpdater
    {
        ...
        // bin\Debug\kezayit\HebrewBooks.csv — the folder the Vue app is served from
        private static readonly string CsvPath =
            Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "kezayit", "HebrewBooks.csv");

        private static readonly string BackupDir =
            Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "kezayit", "backups");
