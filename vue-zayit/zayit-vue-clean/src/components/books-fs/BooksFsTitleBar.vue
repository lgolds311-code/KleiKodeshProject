...
<template>
  <div class="titlebar">
    <BooksBreadcrumb v-if="view !== 'tree' || isSearching" :path="path" @navigate="$emit('navigate', $event)" />
    <button v-else class="home-btn" title="איפוס" @click="$emit('reset')"><IconHome16Regular /></button>
