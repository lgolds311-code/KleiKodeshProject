    ...
    <button :class="['diacritics-btn', { 'state-1': diacriticsState === 1, 'state-2': diacriticsState === 2 }]"
      ...
      <svg v-if="diacriticsState === 0" width="16" height="18" viewBox="0 0 126 139" fill="currentColor">
        <g transform="translate(0,139) scale(0.1,-0.1)">
          ...
          <path d="M450 410c0 27 3 30 30 30s30-3 30-33c0-26 6-36 24-45 37-16 57-54 63-116l6-56H566c-36 0-36 0-36 43 0 113-91 116-106 4-6-44-9-47-35-47-28 0-29 2-29 50 0 63 13 89 55 118 27 17 35 29 35 52Z"/>
